...
801037b4:	bb 74 1f 11 80       	mov    $0x80111f74,%ebx
{
801037b9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801037bc:	68 40 1f 11 80       	push   $0x80111f40
...
801037d3:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
...
801037f4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037f7:	68 40 1f 11 80       	push   $0x80111f40
  p->pid = nextpid++;
801037fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103802:	e8 c9 0e 00 00       	call   801046d0 <release>
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 ed 59 10 80 	movl   $0x801059ed,0x14(%eax)
  p->context = (struct context*)sp;
...
80103836:	e8 b5 0f 00 00       	call   801047f0 <memset>
...
80103853:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103855:	68 40 1f 11 80       	push   $0x80111f40
...
80103883:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103886:	68 40 1f 11 80       	push   $0x80111f40
8010388b:	e8 40 0e 00 00       	call   801046d0 <release>
...
801038db:	68 40 1f 11 80       	push   $0x80111f40
801038e0:	e8 7b 0c 00 00       	call   80104560 <initlock>
}
...
80103945:	68 78 79 10 80       	push   $0x80107978
...
80103974:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103977:	e8 64 0c 00 00       	call   801045e0 <pushcli>
  c = mycpu();
8010397c:	e8 6f ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103981:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103987:	e8 a4 0c 00 00       	call   80104630 <popcli>
}
...
801039ac:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039ae:	a3 74 3e 11 80       	mov    %eax,0x80113e74
  if((p->pgdir = setupkvm()) == 0)
801039b3:	e8 28 36 00 00       	call   80106fe0 <setupkvm>
...
801039e6:	e8 05 0e 00 00       	call   801047f0 <memset>
...
80103a45:	e8 66 0f 00 00       	call   801049b0 <safestrcpy>
  p->cwd = namei("/");
...
80103a56:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a59:	c7 04 24 40 1f 11 80 	movl   $0x80111f40,(%esp)
80103a60:	e8 cb 0c 00 00       	call   80104730 <acquire>
  p->state = RUNNABLE;
80103a65:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a6c:	c7 04 24 40 1f 11 80 	movl   $0x80111f40,(%esp)
...
80103a95:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a98:	e8 43 0b 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80103a9d:	e8 4e fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103aa2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa8:	e8 83 0b 00 00       	call   80104630 <popcli>
  sz = curproc->sz;
...
80103ada:	e8 21 33 00 00       	call   80106e00 <allocuvm>
...
80103afa:	e8 31 34 00 00       	call   80106f30 <deallocuvm>
...
80103b16:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b19:	e8 c2 0a 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80103b1e:	e8 cd fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b29:	e8 02 0b 00 00       	call   80104630 <popcli>
  if((np = allocproc()) == 0){
...
80103b48:	e8 83 35 00 00       	call   801070d0 <copyuvm>
...
80103bc1:	e8 ea 0d 00 00       	call   801049b0 <safestrcpy>
  pid = np->pid;
80103bc6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bc9:	c7 04 24 40 1f 11 80 	movl   $0x80111f40,(%esp)
80103bd0:	e8 5b 0b 00 00       	call   80104730 <acquire>
  np->state = RUNNABLE;
80103bd5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bdc:	c7 04 24 40 1f 11 80 	movl   $0x80111f40,(%esp)
80103be3:	e8 e8 0a 00 00       	call   801046d0 <release>
  return pid;
...
80103c51:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c54:	bb 74 1f 11 80       	mov    $0x80111f74,%ebx
    acquire(&ptable.lock);
80103c59:	68 40 1f 11 80       	push   $0x80111f40
80103c5e:	e8 cd 0a 00 00       	call   80104730 <acquire>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 74 0d 00 00       	call   80104a0b <swtch>
      switchkvm();
80103c97:	e8 d4 2e 00 00       	call   80106b70 <switchkvm>
      c->proc = 0;
...
80103cac:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
80103cb2:	75 bc                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cb4:	83 ec 0c             	sub    $0xc,%esp
80103cb7:	68 40 1f 11 80       	push   $0x80111f40
...
80103cd4:	53                   	push   %ebx
  pushcli();
80103cd5:	e8 06 09 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80103cda:	e8 11 fc ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103cdf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ce5:	e8 46 09 00 00       	call   80104630 <popcli>
  if(!holding(&ptable.lock))
80103cea:	83 ec 0c             	sub    $0xc,%esp
80103ced:	68 40 1f 11 80       	push   $0x80111f40
80103cf2:	e8 99 09 00 00       	call   80104690 <holding>
...
80103d33:	e8 d3 0c 00 00       	call   80104a0b <swtch>
  mycpu()->intena = intena;
...
80103d99:	e8 d2 fb ff ff       	call   80103970 <myproc>
  if(curproc == initproc)
80103d9e:	39 05 74 3e 11 80    	cmp    %eax,0x80113e74
...
80103dec:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103df3:	c7 04 24 40 1f 11 80 	movl   $0x80111f40,(%esp)
80103dfa:	e8 31 09 00 00       	call   80104730 <acquire>
...
80103e2f:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
80103e34:	75 e4                	jne    80103e1a <exit+0x8a>
      p->parent = initproc;
80103e36:	8b 0d 74 3e 11 80    	mov    0x80113e74,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e3c:	ba 74 1f 11 80       	mov    $0x80111f74,%edx
80103e41:	eb 10                	jmp    80103e53 <exit+0xc3>
80103e43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e47:	90                   	nop
80103e48:	83 c2 7c             	add    $0x7c,%edx
80103e4b:	81 fa 74 3e 11 80    	cmp    $0x80113e74,%edx
...
80103e9d:	68 08 79 10 80       	push   $0x80107908
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 fb 78 10 80       	push   $0x801078fb
...
80103f11:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f16:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
...
80103f2b:	0f 85 95 00 00 00    	jne    80103fc6 <wait+0x106>
  pushcli();
80103f31:	e8 aa 06 00 00       	call   801045e0 <pushcli>
  c = mycpu();
...
80103f89:	e8 d2 2f 00 00       	call   80106f60 <freevm>
        p->pid = 0;
...
80103fa7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fae:	c7 04 24 40 1f 11 80 	movl   $0x80111f40,(%esp)
80103fb5:	e8 16 07 00 00       	call   801046d0 <release>
        return pid;
...
80103fc9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fce:	68 40 1f 11 80       	push   $0x80111f40
80103fd3:	e8 f8 06 00 00       	call   801046d0 <release>
      return -1;
80103fd8:	83 c4 10             	add    $0x10,%esp
80103fdb:	eb e0                	jmp    80103fbd <wait+0xfd>
    panic("sleep");
80103fdd:	83 ec 0c             	sub    $0xc,%esp
80103fe0:	68 14 79 10 80       	push   $0x80107914
...
80103ff7:	68 40 1f 11 80       	push   $0x80111f40
80103ffc:	e8 2f 07 00 00       	call   80104730 <acquire>
  pushcli();
80104001:	e8 da 05 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80104006:	e8 e5 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010400b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104011:	e8 1a 06 00 00       	call   80104630 <popcli>
  myproc()->state = RUNNABLE;
80104016:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
8010401d:	e8 ae fc ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80104022:	c7 04 24 40 1f 11 80 	movl   $0x80111f40,(%esp)
80104029:	e8 a2 06 00 00       	call   801046d0 <release>
}
...
8010404c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010404f:	e8 8c 05 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80104054:	e8 97 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104059:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010405f:	e8 cc 05 00 00       	call   80104630 <popcli>
  if(p == 0)
...
80104070:	81 fe 40 1f 11 80    	cmp    $0x80111f40,%esi
80104076:	74 50                	je     801040c8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104078:	83 ec 0c             	sub    $0xc,%esp
8010407b:	68 40 1f 11 80       	push   $0x80111f40
80104080:	e8 ab 06 00 00       	call   80104730 <acquire>
    release(lk);
80104085:	89 34 24             	mov    %esi,(%esp)
80104088:	e8 43 06 00 00       	call   801046d0 <release>
  p->chan = chan;
...
8010409c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801040a3:	c7 04 24 40 1f 11 80 	movl   $0x80111f40,(%esp)
801040aa:	e8 21 06 00 00       	call   801046d0 <release>
    acquire(lk);
...
801040bb:	5d                   	pop    %ebp
    acquire(lk);
801040bc:	e9 6f 06 00 00       	jmp    80104730 <acquire>
...
801040e9:	68 1a 79 10 80       	push   $0x8010791a
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 14 79 10 80       	push   $0x80107914
...
80104107:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010410a:	68 40 1f 11 80       	push   $0x80111f40
8010410f:	e8 1c 06 00 00       	call   80104730 <acquire>
80104114:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104117:	b8 74 1f 11 80       	mov    $0x80111f74,%eax
8010411c:	eb 0c                	jmp    8010412a <wakeup+0x2a>
8010411e:	66 90                	xchg   %ax,%ax
80104120:	83 c0 7c             	add    $0x7c,%eax
80104123:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
...
8010413f:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
80104144:	75 e4                	jne    8010412a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104146:	c7 45 08 40 1f 11 80 	movl   $0x80111f40,0x8(%ebp)
}
8010414d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104150:	c9                   	leave  
  release(&ptable.lock);
80104151:	e9 7a 05 00 00       	jmp    801046d0 <release>
...
80104167:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010416a:	68 40 1f 11 80       	push   $0x80111f40
8010416f:	e8 bc 05 00 00       	call   80104730 <acquire>
80104174:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104177:	b8 74 1f 11 80       	mov    $0x80111f74,%eax
8010417c:	eb 0c                	jmp    8010418a <kill+0x2a>
8010417e:	66 90                	xchg   %ax,%ax
80104180:	83 c0 7c             	add    $0x7c,%eax
80104183:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
...
801041a6:	68 40 1f 11 80       	push   $0x80111f40
801041ab:	e8 20 05 00 00       	call   801046d0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041c3:	68 40 1f 11 80       	push   $0x80111f40
801041c8:	e8 03 05 00 00       	call   801046d0 <release>
}
...
801041e9:	bb e0 1f 11 80       	mov    $0x80111fe0,%ebx
...
8010420b:	81 fb e0 3e 11 80    	cmp    $0x80113ee0,%ebx
...
8010421c:	74 ea                	je     80104208 <procdump+0x28>
      state = "???";
8010421e:	ba 2b 79 10 80       	mov    $0x8010792b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104223:	83 f8 05             	cmp    $0x5,%eax
80104226:	77 11                	ja     80104239 <procdump+0x59>
80104228:	8b 14 85 d8 79 10 80 	mov    -0x7fef8628(,%eax,4),%edx
      state = "???";
8010422f:	b8 2b 79 10 80       	mov    $0x8010792b,%eax
...
8010423e:	68 2f 79 10 80       	push   $0x8010792f
...
80104265:	e8 16 03 00 00       	call   80104580 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010427d:	68 81 73 10 80       	push   $0x80107381
...
801042a6:	83 ec 04             	sub    $0x4,%esp
    int i, j;
    struct proc_info temp;
    for (i = 0; i < len; i++) {
801042a9:	8b 1d 20 1d 11 80    	mov    0x80111d20,%ebx
801042af:	85 db                	test   %ebx,%ebx
801042b1:	0f 8e b7 00 00 00    	jle    8010436e <sort_process+0xce>
801042b7:	31 d2                	xor    %edx,%edx
801042b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        for (j = i + 1; j < len; j++) {
801042c0:	83 c2 01             	add    $0x1,%edx
801042c3:	39 da                	cmp    %ebx,%edx
801042c5:	0f 8d 9d 00 00 00    	jge    80104368 <sort_process+0xc8>
801042cb:	89 d0                	mov    %edx,%eax
801042cd:	eb 3f                	jmp    8010430e <sort_process+0x6e>
801042cf:	90                   	nop
            if (process[i].memsize > process[j].memsize) {
                temp = process[i];
801042d0:	8b 3c d5 38 1d 11 80 	mov    -0x7feee2c8(,%edx,8),%edi
                process[i] = process[j];
801042d7:	8b 34 c5 40 1d 11 80 	mov    -0x7feee2c0(,%eax,8),%esi
                temp = process[i];
801042de:	89 7d f0             	mov    %edi,-0x10(%ebp)
                process[i] = process[j];
801042e1:	8b 3c c5 44 1d 11 80 	mov    -0x7feee2bc(,%eax,8),%edi
801042e8:	89 34 d5 38 1d 11 80 	mov    %esi,-0x7feee2c8(,%edx,8)
801042ef:	89 3c d5 3c 1d 11 80 	mov    %edi,-0x7feee2c4(,%edx,8)
                process[j] = temp;
801042f6:	8b 7d f0             	mov    -0x10(%ebp),%edi
801042f9:	89 0c c5 44 1d 11 80 	mov    %ecx,-0x7feee2bc(,%eax,8)
80104300:	89 3c c5 40 1d 11 80 	mov    %edi,-0x7feee2c0(,%eax,8)
        for (j = i + 1; j < len; j++) {
80104307:	83 c0 01             	add    $0x1,%eax
8010430a:	39 d8                	cmp    %ebx,%eax
8010430c:	74 b2                	je     801042c0 <sort_process+0x20>
            if (process[i].memsize > process[j].memsize) {
8010430e:	8b 0c d5 3c 1d 11 80 	mov    -0x7feee2c4(,%edx,8),%ecx
80104315:	3b 0c c5 44 1d 11 80 	cmp    -0x7feee2bc(,%eax,8),%ecx
8010431c:	7f b2                	jg     801042d0 <sort_process+0x30>
            }
            else if(process[i].memsize == process[j].memsize){
8010431e:	75 e7                	jne    80104307 <sort_process+0x67>
                if(process[i].pid > process[j].pid){
80104320:	8b 34 d5 38 1d 11 80 	mov    -0x7feee2c8(,%edx,8),%esi
80104327:	89 75 f0             	mov    %esi,-0x10(%ebp)
8010432a:	3b 34 c5 40 1d 11 80 	cmp    -0x7feee2c0(,%eax,8),%esi
80104331:	7e d4                	jle    80104307 <sort_process+0x67>
                    temp = process[i];
                    process[i] = process[j];
80104333:	8b 34 c5 40 1d 11 80 	mov    -0x7feee2c0(,%eax,8),%esi
8010433a:	8b 3c c5 44 1d 11 80 	mov    -0x7feee2bc(,%eax,8),%edi
80104341:	89 34 d5 38 1d 11 80 	mov    %esi,-0x7feee2c8(,%edx,8)
                    process[j] = temp;
80104348:	8b 75 f0             	mov    -0x10(%ebp),%esi
                    process[i] = process[j];
8010434b:	89 3c d5 3c 1d 11 80 	mov    %edi,-0x7feee2c4(,%edx,8)
                    process[j] = temp;
80104352:	89 34 c5 40 1d 11 80 	mov    %esi,-0x7feee2c0(,%eax,8)
80104359:	89 0c c5 44 1d 11 80 	mov    %ecx,-0x7feee2bc(,%eax,8)
80104360:	eb a5                	jmp    80104307 <sort_process+0x67>
80104362:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for (i = 0; i < len; i++) {
80104368:	0f 85 52 ff ff ff    	jne    801042c0 <sort_process+0x20>
                }
            }
        }
    }
...
80104380:	55                   	push   %ebp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104381:	b8 74 1f 11 80       	mov    $0x80111f74,%eax
{
80104386:	89 e5                	mov    %esp,%ebp
80104388:	53                   	push   %ebx
80104389:	31 db                	xor    %ebx,%ebx
8010438b:	83 ec 04             	sub    $0x4,%esp
8010438e:	8b 0d 20 1d 11 80    	mov    0x80111d20,%ecx
80104394:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(p->state == UNUSED || !(p->state == RUNNABLE || p->state == RUNNING))
80104398:	8b 50 0c             	mov    0xc(%eax),%edx
8010439b:	83 ea 03             	sub    $0x3,%edx
8010439e:	83 fa 01             	cmp    $0x1,%edx
801043a1:	77 1b                	ja     801043be <proc_dump+0x3e>
      continue;
    state = state;
    process[len].pid = p->pid;
801043a3:	8b 50 10             	mov    0x10(%eax),%edx
    process[len].memsize = p->sz;
    len++;
801043a6:	bb 01 00 00 00       	mov    $0x1,%ebx
    process[len].pid = p->pid;
801043ab:	89 14 cd 40 1d 11 80 	mov    %edx,-0x7feee2c0(,%ecx,8)
    process[len].memsize = p->sz;
801043b2:	8b 10                	mov    (%eax),%edx
801043b4:	89 14 cd 44 1d 11 80 	mov    %edx,-0x7feee2bc(,%ecx,8)
    len++;
801043bb:	83 c1 01             	add    $0x1,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043be:	83 c0 7c             	add    $0x7c,%eax
801043c1:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
801043c6:	75 d0                	jne    80104398 <proc_dump+0x18>
801043c8:	84 db                	test   %bl,%bl
801043ca:	74 06                	je     801043d2 <proc_dump+0x52>
801043cc:	89 0d 20 1d 11 80    	mov    %ecx,0x80111d20
  }  
  sort_process();
801043d2:	e8 c9 fe ff ff       	call   801042a0 <sort_process>
  for(int i = 0; i < len; i++){
801043d7:	a1 20 1d 11 80       	mov    0x80111d20,%eax
801043dc:	31 db                	xor    %ebx,%ebx
801043de:	85 c0                	test   %eax,%eax
801043e0:	7e 3c                	jle    8010441e <proc_dump+0x9e>
801043e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      cprintf("------------------------------------------------------\n");
801043e8:	83 ec 0c             	sub    $0xc,%esp
801043eb:	68 a0 79 10 80       	push   $0x801079a0
801043f0:	e8 ab c2 ff ff       	call   801006a0 <cprintf>
      cprintf("pid: %d  |  size: %d\n", process[i].pid, process[i].memsize);
801043f5:	83 c4 0c             	add    $0xc,%esp
801043f8:	ff 34 dd 44 1d 11 80 	push   -0x7feee2bc(,%ebx,8)
801043ff:	ff 34 dd 40 1d 11 80 	push   -0x7feee2c0(,%ebx,8)
  for(int i = 0; i < len; i++){
80104406:	83 c3 01             	add    $0x1,%ebx
      cprintf("pid: %d  |  size: %d\n", process[i].pid, process[i].memsize);
80104409:	68 38 79 10 80       	push   $0x80107938
8010440e:	e8 8d c2 ff ff       	call   801006a0 <cprintf>
  for(int i = 0; i < len; i++){
80104413:	83 c4 10             	add    $0x10,%esp
80104416:	39 1d 20 1d 11 80    	cmp    %ebx,0x80111d20
8010441c:	7f ca                	jg     801043e8 <proc_dump+0x68>
  }
  return 0;
}
...
8010443a:	68 f0 79 10 80       	push   $0x801079f0
...
80104495:	e8 a6 fb ff ff       	call   80104040 <sleep>
  while (lk->locked) {
...
801044a3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801044a9:	e8 c2 f4 ff ff       	call   80103970 <myproc>
...
801044f4:	e8 07 fc ff ff       	call   80104100 <wakeup>
  release(&lk->lk);
...
8010454b:	e8 20 f4 ff ff       	call   80103970 <myproc>
...
8010460a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104610:	e8 db f2 ff ff       	call   801038f0 <mycpu>
...
8010463b:	75 35                	jne    80104672 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
8010463d:	e8 ae f2 ff ff       	call   801038f0 <mycpu>
...
8010465c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104660:	e8 8b f2 ff ff       	call   801038f0 <mycpu>
...
80104675:	68 fb 79 10 80       	push   $0x801079fb
8010467a:	e8 01 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010467f:	83 ec 0c             	sub    $0xc,%esp
80104682:	68 12 7a 10 80       	push   $0x80107a12
...
801046b3:	e8 38 f2 ff ff       	call   801038f0 <mycpu>
...
801046eb:	68 19 7a 10 80       	push   $0x80107a19
...
8010476c:	e8 7f f1 ff ff       	call   801038f0 <mycpu>
...
801047e0:	68 21 7a 10 80       	push   $0x80107a21
...
80104a67:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a6a:	e8 01 ef ff ff       	call   80103970 <myproc>
...
80104ab5:	e8 b6 ee ff ff       	call   80103970 <myproc>
...
80104ac3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ac6:	e8 a5 ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b06:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104b09:	e8 62 ee ff ff       	call   80103970 <myproc>
80104b0e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b10:	e8 5b ee ff ff       	call   80103970 <myproc>
...
80104b1e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b21:	e8 4a ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b74:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b75:	e8 f6 ed ff ff       	call   80103970 <myproc>
...
80104b83:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b86:	e8 e5 ed ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b9b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104b9e:	e8 cd ed ff ff       	call   80103970 <myproc>
  if(addr >= curproc->sz)
...
80104bf4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104bf7:	e8 74 ed ff ff       	call   80103970 <myproc>
...
80104c07:	83 fa 15             	cmp    $0x15,%edx
80104c0a:	77 24                	ja     80104c30 <syscall+0x40>
80104c0c:	8b 14 85 60 7a 10 80 	mov    -0x7fef85a0(,%eax,4),%edx
...
80104c38:	68 29 7a 10 80       	push   $0x80107a29
...
80104d94:	68 d8 7a 10 80       	push   $0x80107ad8
...
80104dac:	68 d7 7a 10 80       	push   $0x80107ad7
...
80104dc1:	68 cb 7a 10 80       	push   $0x80107acb
...
80104ddf:	68 da 7a 10 80       	push   $0x80107ada
80104de4:	e8 97 b5 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104de9:	83 ec 0c             	sub    $0xc,%esp
80104dec:	68 bc 7a 10 80       	push   $0x80107abc
...
80104fb1:	74 25                	je     80104fd8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104fb3:	e8 b8 e9 ff ff       	call   80103970 <myproc>
  fileclose(f);
...
801051ed:	58                   	pop    %eax
801051ee:	5a                   	pop    %edx
801051ef:	68 d8 7a 10 80       	push   $0x80107ad8
...
80105208:	68 d7 7a 10 80       	push   $0x80107ad7
...
801053f7:	74 23                	je     8010541c <sys_open+0x9c>
  struct proc *curproc = myproc();
801053f9:	e8 72 e5 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801055b5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801055b8:	e8 b3 e3 ff ff       	call   80103970 <myproc>
...
801057e6:	75 f0                	jne    801057d8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801057e8:	e8 83 e1 ff ff       	call   80103970 <myproc>
...
{
  return fork();
80105820:	e9 eb e2 ff ff       	jmp    80103b10 <fork>
...
80105833:	83 ec 08             	sub    $0x8,%esp
  exit();
80105836:	e8 55 e5 ff ff       	call   80103d90 <exit>
...
{
  return wait();
80105840:	e9 7b e6 ff ff       	jmp    80103ec0 <wait>
...
8010586e:	e8 ed e8 ff ff       	call   80104160 <kill>
...
80105893:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105896:	e8 d5 e0 ff ff       	call   80103970 <myproc>
...
801058c6:	e8 c5 e1 ff ff       	call   80103a90 <growproc>
...
80105910:	68 a0 3e 11 80       	push   $0x80113ea0
80105915:	e8 16 ee ff ff       	call   80104730 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010591a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010591d:	8b 1d 80 3e 11 80    	mov    0x80113e80,%ebx
  while(ticks - ticks0 < n){
...
80105933:	68 a0 3e 11 80       	push   $0x80113ea0
80105938:	68 80 3e 11 80       	push   $0x80113e80
8010593d:	e8 fe e6 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105942:	a1 80 3e 11 80       	mov    0x80113e80,%eax
...
8010594f:	73 2f                	jae    80105980 <sys_sleep+0x90>
    if(myproc()->killed){
80105951:	e8 1a e0 ff ff       	call   80103970 <myproc>
...
80105960:	68 a0 3e 11 80       	push   $0x80113ea0
80105965:	e8 66 ed ff ff       	call   801046d0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105983:	68 a0 3e 11 80       	push   $0x80113ea0
80105988:	e8 43 ed ff ff       	call   801046d0 <release>
  return 0;
...
801059a4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059a7:	68 a0 3e 11 80       	push   $0x80113ea0
801059ac:	e8 7f ed ff ff       	call   80104730 <acquire>
  xticks = ticks;
801059b1:	8b 1d 80 3e 11 80    	mov    0x80113e80,%ebx
  release(&tickslock);
801059b7:	c7 04 24 a0 3e 11 80 	movl   $0x80113ea0,(%esp)
801059be:	e8 0d ed ff ff       	call   801046d0 <release>
  return xticks;
}
...
801059d0 <sys_proc_dump>:

int
sys_proc_dump(void)
{
  return proc_dump();
801059d0:	e9 ab e9 ff ff       	jmp    80104380 <proc_dump>
...
801059d6:	06                   	push   %es
  pushl %fs
801059d7:	0f a0                	push   %fs
  pushl %gs
801059d9:	0f a8                	push   %gs
  pushal
801059db:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801059dc:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801059e0:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801059e2:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801059e4:	54                   	push   %esp
  call trap
801059e5:	e8 c6 00 00 00       	call   80105ab0 <trap>
  addl $4, %esp
801059ea:	83 c4 04             	add    $0x4,%esp
...
801059ed:	61                   	popa   
  popl %gs
801059ee:	0f a9                	pop    %gs
  popl %fs
801059f0:	0f a1                	pop    %fs
  popl %es
801059f2:	07                   	pop    %es
  popl %ds
801059f3:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801059f4:	83 c4 08             	add    $0x8,%esp
  iret
801059f7:	cf                   	iret   
...
80105a17:	c7 04 c5 e2 3e 11 80 	movl   $0x8e000008,-0x7feec11e(,%eax,8)
80105a1e:	08 00 00 8e 
80105a22:	66 89 14 c5 e0 3e 11 	mov    %dx,-0x7feec120(,%eax,8)
80105a29:	80 
80105a2a:	c1 ea 10             	shr    $0x10,%edx
80105a2d:	66 89 14 c5 e6 3e 11 	mov    %dx,-0x7feec11a(,%eax,8)
80105a34:	80 
  for(i = 0; i < 256; i++)
...
80105a47:	c7 05 e2 40 11 80 08 	movl   $0xef000008,0x801140e2
80105a4e:	00 00 ef 
  initlock(&tickslock, "time");
80105a51:	68 1d 7b 10 80       	push   $0x80107b1d
80105a56:	68 a0 3e 11 80       	push   $0x80113ea0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a5b:	66 a3 e0 40 11 80    	mov    %ax,0x801140e0
80105a61:	c1 e8 10             	shr    $0x10,%eax
80105a64:	66 a3 e6 40 11 80    	mov    %ax,0x801140e6
  initlock(&tickslock, "time");
80105a6a:	e8 f1 ea ff ff       	call   80104560 <initlock>
}
...
80105a8b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a8f:	b8 e0 3e 11 80       	mov    $0x80113ee0,%eax
...
80105ad4:	ff 24 85 c4 7b 10 80 	jmp    *-0x7fef843c(,%eax,4)
...
80105af3:	e8 78 de ff ff       	call   80103970 <myproc>
...
80105b31:	e8 3a de ff ff       	call   80103970 <myproc>
...
80105bb5:	68 80 7b 10 80       	push   $0x80107b80
80105bba:	e8 e1 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105bbf:	83 c4 20             	add    $0x20,%esp
80105bc2:	e8 a9 dd ff ff       	call   80103970 <myproc>
80105bc7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bce:	e8 9d dd ff ff       	call   80103970 <myproc>
...
80105be4:	0f 85 3e ff ff ff    	jne    80105b28 <trap+0x78>
    yield();
80105bea:	e8 01 e4 ff ff       	call   80103ff0 <yield>
...
80105bff:	e8 4c dd ff ff       	call   80103950 <cpuid>
80105c04:	57                   	push   %edi
80105c05:	56                   	push   %esi
80105c06:	50                   	push   %eax
80105c07:	68 28 7b 10 80       	push   $0x80107b28
...
80105c45:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c48:	e8 a3 ef ff ff       	call   80104bf0 <syscall>
    if(myproc()->killed)
80105c4d:	e8 1e dd ff ff       	call   80103970 <myproc>
...
80105c63:	5d                   	pop    %ebp
      exit();
80105c64:	e9 27 e1 ff ff       	jmp    80103d90 <exit>
...
80105cac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105cb0:	e8 9b dc ff ff       	call   80103950 <cpuid>
80105cb5:	85 c0                	test   %eax,%eax
80105cb7:	0f 85 28 fe ff ff    	jne    80105ae5 <trap+0x35>
      acquire(&tickslock);
80105cbd:	83 ec 0c             	sub    $0xc,%esp
80105cc0:	68 a0 3e 11 80       	push   $0x80113ea0
80105cc5:	e8 66 ea ff ff       	call   80104730 <acquire>
      wakeup(&ticks);
80105cca:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
      ticks++;
80105cd1:	83 05 80 3e 11 80 01 	addl   $0x1,0x80113e80
      wakeup(&ticks);
80105cd8:	e8 23 e4 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105cdd:	c7 04 24 a0 3e 11 80 	movl   $0x80113ea0,(%esp)
80105ce4:	e8 e7 e9 ff ff       	call   801046d0 <release>
...
{
  if(!uart)
80105d40:	a1 e0 46 11 80       	mov    0x801146e0,%eax
...
80105dc7:	74 78                	je     80105e41 <uartinit+0xd1>
  uart = 1;
80105dc9:	c7 05 e0 46 11 80 01 	movl   $0x1,0x801146e0
80105dd0:	00 00 00 
...
80105ddc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ddf:	bf 44 7c 10 80       	mov    $0x80107c44,%edi
...
80105df9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105e00:	a1 e0 46 11 80       	mov    0x801146e0,%eax
...
80105ec7:	6a 00                	push   $0x0
  jmp alltraps
80105ec9:	e9 07 fb ff ff       	jmp    801059d5 <alltraps>
...
80105ed0:	6a 01                	push   $0x1
  jmp alltraps
80105ed2:	e9 fe fa ff ff       	jmp    801059d5 <alltraps>
...
80105ed9:	6a 02                	push   $0x2
  jmp alltraps
80105edb:	e9 f5 fa ff ff       	jmp    801059d5 <alltraps>
...
80105ee2:	6a 03                	push   $0x3
  jmp alltraps
80105ee4:	e9 ec fa ff ff       	jmp    801059d5 <alltraps>
...
80105eeb:	6a 04                	push   $0x4
  jmp alltraps
80105eed:	e9 e3 fa ff ff       	jmp    801059d5 <alltraps>
...
80105ef4:	6a 05                	push   $0x5
  jmp alltraps
80105ef6:	e9 da fa ff ff       	jmp    801059d5 <alltraps>
...
80105efd:	6a 06                	push   $0x6
  jmp alltraps
80105eff:	e9 d1 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f06:	6a 07                	push   $0x7
  jmp alltraps
80105f08:	e9 c8 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f0d:	6a 08                	push   $0x8
  jmp alltraps
80105f0f:	e9 c1 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f16:	6a 09                	push   $0x9
  jmp alltraps
80105f18:	e9 b8 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f1d:	6a 0a                	push   $0xa
  jmp alltraps
80105f1f:	e9 b1 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f24:	6a 0b                	push   $0xb
  jmp alltraps
80105f26:	e9 aa fa ff ff       	jmp    801059d5 <alltraps>
...
80105f2b:	6a 0c                	push   $0xc
  jmp alltraps
80105f2d:	e9 a3 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f32:	6a 0d                	push   $0xd
  jmp alltraps
80105f34:	e9 9c fa ff ff       	jmp    801059d5 <alltraps>
...
80105f39:	6a 0e                	push   $0xe
  jmp alltraps
80105f3b:	e9 95 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f42:	6a 0f                	push   $0xf
  jmp alltraps
80105f44:	e9 8c fa ff ff       	jmp    801059d5 <alltraps>
...
80105f4b:	6a 10                	push   $0x10
  jmp alltraps
80105f4d:	e9 83 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f52:	6a 11                	push   $0x11
  jmp alltraps
80105f54:	e9 7c fa ff ff       	jmp    801059d5 <alltraps>
...
80105f5b:	6a 12                	push   $0x12
  jmp alltraps
80105f5d:	e9 73 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f64:	6a 13                	push   $0x13
  jmp alltraps
80105f66:	e9 6a fa ff ff       	jmp    801059d5 <alltraps>
...
80105f6d:	6a 14                	push   $0x14
  jmp alltraps
80105f6f:	e9 61 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f76:	6a 15                	push   $0x15
  jmp alltraps
80105f78:	e9 58 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f7f:	6a 16                	push   $0x16
  jmp alltraps
80105f81:	e9 4f fa ff ff       	jmp    801059d5 <alltraps>
...
80105f88:	6a 17                	push   $0x17
  jmp alltraps
80105f8a:	e9 46 fa ff ff       	jmp    801059d5 <alltraps>
...
80105f91:	6a 18                	push   $0x18
  jmp alltraps
80105f93:	e9 3d fa ff ff       	jmp    801059d5 <alltraps>
...
80105f9a:	6a 19                	push   $0x19
  jmp alltraps
80105f9c:	e9 34 fa ff ff       	jmp    801059d5 <alltraps>
...
80105fa3:	6a 1a                	push   $0x1a
  jmp alltraps
80105fa5:	e9 2b fa ff ff       	jmp    801059d5 <alltraps>
...
80105fac:	6a 1b                	push   $0x1b
  jmp alltraps
80105fae:	e9 22 fa ff ff       	jmp    801059d5 <alltraps>
...
80105fb5:	6a 1c                	push   $0x1c
  jmp alltraps
80105fb7:	e9 19 fa ff ff       	jmp    801059d5 <alltraps>
...
80105fbe:	6a 1d                	push   $0x1d
  jmp alltraps
80105fc0:	e9 10 fa ff ff       	jmp    801059d5 <alltraps>
...
80105fc7:	6a 1e                	push   $0x1e
  jmp alltraps
80105fc9:	e9 07 fa ff ff       	jmp    801059d5 <alltraps>
...
80105fd0:	6a 1f                	push   $0x1f
  jmp alltraps
80105fd2:	e9 fe f9 ff ff       	jmp    801059d5 <alltraps>
...
80105fd9:	6a 20                	push   $0x20
  jmp alltraps
80105fdb:	e9 f5 f9 ff ff       	jmp    801059d5 <alltraps>
...
80105fe2:	6a 21                	push   $0x21
  jmp alltraps
80105fe4:	e9 ec f9 ff ff       	jmp    801059d5 <alltraps>
...
80105feb:	6a 22                	push   $0x22
  jmp alltraps
80105fed:	e9 e3 f9 ff ff       	jmp    801059d5 <alltraps>
...
80105ff4:	6a 23                	push   $0x23
  jmp alltraps
80105ff6:	e9 da f9 ff ff       	jmp    801059d5 <alltraps>
...
80105ffd:	6a 24                	push   $0x24
  jmp alltraps
80105fff:	e9 d1 f9 ff ff       	jmp    801059d5 <alltraps>
...
80106006:	6a 25                	push   $0x25
  jmp alltraps
80106008:	e9 c8 f9 ff ff       	jmp    801059d5 <alltraps>
...
8010600f:	6a 26                	push   $0x26
  jmp alltraps
80106011:	e9 bf f9 ff ff       	jmp    801059d5 <alltraps>
...
80106018:	6a 27                	push   $0x27
  jmp alltraps
8010601a:	e9 b6 f9 ff ff       	jmp    801059d5 <alltraps>
...
80106021:	6a 28                	push   $0x28
  jmp alltraps
80106023:	e9 ad f9 ff ff       	jmp    801059d5 <alltraps>
...
8010602a:	6a 29                	push   $0x29
  jmp alltraps
8010602c:	e9 a4 f9 ff ff       	jmp    801059d5 <alltraps>
...
80106033:	6a 2a                	push   $0x2a
  jmp alltraps
80106035:	e9 9b f9 ff ff       	jmp    801059d5 <alltraps>
...
8010603c:	6a 2b                	push   $0x2b
  jmp alltraps
8010603e:	e9 92 f9 ff ff       	jmp    801059d5 <alltraps>
...
80106045:	6a 2c                	push   $0x2c
  jmp alltraps
80106047:	e9 89 f9 ff ff       	jmp    801059d5 <alltraps>
...
8010604e:	6a 2d                	push   $0x2d
  jmp alltraps
80106050:	e9 80 f9 ff ff       	jmp    801059d5 <alltraps>
...
80106057:	6a 2e                	push   $0x2e
  jmp alltraps
80106059:	e9 77 f9 ff ff       	jmp    801059d5 <alltraps>
...
80106060:	6a 2f                	push   $0x2f
  jmp alltraps
80106062:	e9 6e f9 ff ff       	jmp    801059d5 <alltraps>
...
80106069:	6a 30                	push   $0x30
  jmp alltraps
8010606b:	e9 65 f9 ff ff       	jmp    801059d5 <alltraps>
...
80106072:	6a 31                	push   $0x31
  jmp alltraps
80106074:	e9 5c f9 ff ff       	jmp    801059d5 <alltraps>
...
8010607b:	6a 32                	push   $0x32
  jmp alltraps
8010607d:	e9 53 f9 ff ff       	jmp    801059d5 <alltraps>
...
80106084:	6a 33                	push   $0x33
  jmp alltraps
80106086:	e9 4a f9 ff ff       	jmp    801059d5 <alltraps>
...
8010608d:	6a 34                	push   $0x34
  jmp alltraps
8010608f:	e9 41 f9 ff ff       	jmp    801059d5 <alltraps>
...
80106096:	6a 35                	push   $0x35
  jmp alltraps
80106098:	e9 38 f9 ff ff       	jmp    801059d5 <alltraps>
...
8010609f:	6a 36                	push   $0x36
  jmp alltraps
801060a1:	e9 2f f9 ff ff       	jmp    801059d5 <alltraps>
...
801060a8:	6a 37                	push   $0x37
  jmp alltraps
801060aa:	e9 26 f9 ff ff       	jmp    801059d5 <alltraps>
...
801060b1:	6a 38                	push   $0x38
  jmp alltraps
801060b3:	e9 1d f9 ff ff       	jmp    801059d5 <alltraps>
...
801060ba:	6a 39                	push   $0x39
  jmp alltraps
801060bc:	e9 14 f9 ff ff       	jmp    801059d5 <alltraps>
...
801060c3:	6a 3a                	push   $0x3a
  jmp alltraps
801060c5:	e9 0b f9 ff ff       	jmp    801059d5 <alltraps>
...
801060cc:	6a 3b                	push   $0x3b
  jmp alltraps
801060ce:	e9 02 f9 ff ff       	jmp    801059d5 <alltraps>
...
801060d5:	6a 3c                	push   $0x3c
  jmp alltraps
801060d7:	e9 f9 f8 ff ff       	jmp    801059d5 <alltraps>
...
801060de:	6a 3d                	push   $0x3d
  jmp alltraps
801060e0:	e9 f0 f8 ff ff       	jmp    801059d5 <alltraps>
...
801060e7:	6a 3e                	push   $0x3e
  jmp alltraps
801060e9:	e9 e7 f8 ff ff       	jmp    801059d5 <alltraps>
...
801060f0:	6a 3f                	push   $0x3f
  jmp alltraps
801060f2:	e9 de f8 ff ff       	jmp    801059d5 <alltraps>
...
801060f9:	6a 40                	push   $0x40
  jmp alltraps
801060fb:	e9 d5 f8 ff ff       	jmp    801059d5 <alltraps>
...
80106102:	6a 41                	push   $0x41
  jmp alltraps
80106104:	e9 cc f8 ff ff       	jmp    801059d5 <alltraps>
...
8010610b:	6a 42                	push   $0x42
  jmp alltraps
8010610d:	e9 c3 f8 ff ff       	jmp    801059d5 <alltraps>
...
80106114:	6a 43                	push   $0x43
  jmp alltraps
80106116:	e9 ba f8 ff ff       	jmp    801059d5 <alltraps>
...
8010611d:	6a 44                	push   $0x44
  jmp alltraps
8010611f:	e9 b1 f8 ff ff       	jmp    801059d5 <alltraps>
...
80106126:	6a 45                	push   $0x45
  jmp alltraps
80106128:	e9 a8 f8 ff ff       	jmp    801059d5 <alltraps>
...
8010612f:	6a 46                	push   $0x46
  jmp alltraps
80106131:	e9 9f f8 ff ff       	jmp    801059d5 <alltraps>
...
80106138:	6a 47                	push   $0x47
  jmp alltraps
8010613a:	e9 96 f8 ff ff       	jmp    801059d5 <alltraps>
...
80106141:	6a 48                	push   $0x48
  jmp alltraps
80106143:	e9 8d f8 ff ff       	jmp    801059d5 <alltraps>
...
8010614a:	6a 49                	push   $0x49
  jmp alltraps
8010614c:	e9 84 f8 ff ff       	jmp    801059d5 <alltraps>
...
80106153:	6a 4a                	push   $0x4a
  jmp alltraps
80106155:	e9 7b f8 ff ff       	jmp    801059d5 <alltraps>
...
8010615c:	6a 4b                	push   $0x4b
  jmp alltraps
8010615e:	e9 72 f8 ff ff       	jmp    801059d5 <alltraps>
...
80106165:	6a 4c                	push   $0x4c
  jmp alltraps
80106167:	e9 69 f8 ff ff       	jmp    801059d5 <alltraps>
...
8010616e:	6a 4d                	push   $0x4d
  jmp alltraps
80106170:	e9 60 f8 ff ff       	jmp    801059d5 <alltraps>
...
80106177:	6a 4e                	push   $0x4e
  jmp alltraps
80106179:	e9 57 f8 ff ff       	jmp    801059d5 <alltraps>
...
80106180:	6a 4f                	push   $0x4f
  jmp alltraps
80106182:	e9 4e f8 ff ff       	jmp    801059d5 <alltraps>
...
80106189:	6a 50                	push   $0x50
  jmp alltraps
8010618b:	e9 45 f8 ff ff       	jmp    801059d5 <alltraps>
...
80106192:	6a 51                	push   $0x51
  jmp alltraps
80106194:	e9 3c f8 ff ff       	jmp    801059d5 <alltraps>
...
8010619b:	6a 52                	push   $0x52
  jmp alltraps
8010619d:	e9 33 f8 ff ff       	jmp    801059d5 <alltraps>
...
801061a4:	6a 53                	push   $0x53
  jmp alltraps
801061a6:	e9 2a f8 ff ff       	jmp    801059d5 <alltraps>
...
801061ad:	6a 54                	push   $0x54
  jmp alltraps
801061af:	e9 21 f8 ff ff       	jmp    801059d5 <alltraps>
...
801061b6:	6a 55                	push   $0x55
  jmp alltraps
801061b8:	e9 18 f8 ff ff       	jmp    801059d5 <alltraps>
...
801061bf:	6a 56                	push   $0x56
  jmp alltraps
801061c1:	e9 0f f8 ff ff       	jmp    801059d5 <alltraps>
...
801061c8:	6a 57                	push   $0x57
  jmp alltraps
801061ca:	e9 06 f8 ff ff       	jmp    801059d5 <alltraps>
...
801061d1:	6a 58                	push   $0x58
  jmp alltraps
801061d3:	e9 fd f7 ff ff       	jmp    801059d5 <alltraps>
...
801061da:	6a 59                	push   $0x59
  jmp alltraps
801061dc:	e9 f4 f7 ff ff       	jmp    801059d5 <alltraps>
...
801061e3:	6a 5a                	push   $0x5a
  jmp alltraps
801061e5:	e9 eb f7 ff ff       	jmp    801059d5 <alltraps>
...
801061ec:	6a 5b                	push   $0x5b
  jmp alltraps
801061ee:	e9 e2 f7 ff ff       	jmp    801059d5 <alltraps>
...
801061f5:	6a 5c                	push   $0x5c
  jmp alltraps
801061f7:	e9 d9 f7 ff ff       	jmp    801059d5 <alltraps>
...
801061fe:	6a 5d                	push   $0x5d
  jmp alltraps
80106200:	e9 d0 f7 ff ff       	jmp    801059d5 <alltraps>
...
80106207:	6a 5e                	push   $0x5e
  jmp alltraps
80106209:	e9 c7 f7 ff ff       	jmp    801059d5 <alltraps>
...
80106210:	6a 5f                	push   $0x5f
  jmp alltraps
80106212:	e9 be f7 ff ff       	jmp    801059d5 <alltraps>
...
80106219:	6a 60                	push   $0x60
  jmp alltraps
8010621b:	e9 b5 f7 ff ff       	jmp    801059d5 <alltraps>
...
80106222:	6a 61                	push   $0x61
  jmp alltraps
80106224:	e9 ac f7 ff ff       	jmp    801059d5 <alltraps>
...
8010622b:	6a 62                	push   $0x62
  jmp alltraps
8010622d:	e9 a3 f7 ff ff       	jmp    801059d5 <alltraps>
...
80106234:	6a 63                	push   $0x63
  jmp alltraps
80106236:	e9 9a f7 ff ff       	jmp    801059d5 <alltraps>
...
8010623d:	6a 64                	push   $0x64
  jmp alltraps
8010623f:	e9 91 f7 ff ff       	jmp    801059d5 <alltraps>
...
80106246:	6a 65                	push   $0x65
  jmp alltraps
80106248:	e9 88 f7 ff ff       	jmp    801059d5 <alltraps>
...
8010624f:	6a 66                	push   $0x66
  jmp alltraps
80106251:	e9 7f f7 ff ff       	jmp    801059d5 <alltraps>
...
80106258:	6a 67                	push   $0x67
  jmp alltraps
8010625a:	e9 76 f7 ff ff       	jmp    801059d5 <alltraps>
...
80106261:	6a 68                	push   $0x68
  jmp alltraps
80106263:	e9 6d f7 ff ff       	jmp    801059d5 <alltraps>
...
8010626a:	6a 69                	push   $0x69
  jmp alltraps
8010626c:	e9 64 f7 ff ff       	jmp    801059d5 <alltraps>
...
80106273:	6a 6a                	push   $0x6a
  jmp alltraps
80106275:	e9 5b f7 ff ff       	jmp    801059d5 <alltraps>
...
8010627c:	6a 6b                	push   $0x6b
  jmp alltraps
8010627e:	e9 52 f7 ff ff       	jmp    801059d5 <alltraps>
...
80106285:	6a 6c                	push   $0x6c
  jmp alltraps
80106287:	e9 49 f7 ff ff       	jmp    801059d5 <alltraps>
...
8010628e:	6a 6d                	push   $0x6d
  jmp alltraps
80106290:	e9 40 f7 ff ff       	jmp    801059d5 <alltraps>
...
80106297:	6a 6e                	push   $0x6e
  jmp alltraps
80106299:	e9 37 f7 ff ff       	jmp    801059d5 <alltraps>
...
801062a0:	6a 6f                	push   $0x6f
  jmp alltraps
801062a2:	e9 2e f7 ff ff       	jmp    801059d5 <alltraps>
...
801062a9:	6a 70                	push   $0x70
  jmp alltraps
801062ab:	e9 25 f7 ff ff       	jmp    801059d5 <alltraps>
...
801062b2:	6a 71                	push   $0x71
  jmp alltraps
801062b4:	e9 1c f7 ff ff       	jmp    801059d5 <alltraps>
...
801062bb:	6a 72                	push   $0x72
  jmp alltraps
801062bd:	e9 13 f7 ff ff       	jmp    801059d5 <alltraps>
...
801062c4:	6a 73                	push   $0x73
  jmp alltraps
801062c6:	e9 0a f7 ff ff       	jmp    801059d5 <alltraps>
...
801062cd:	6a 74                	push   $0x74
  jmp alltraps
801062cf:	e9 01 f7 ff ff       	jmp    801059d5 <alltraps>
...
801062d6:	6a 75                	push   $0x75
  jmp alltraps
801062d8:	e9 f8 f6 ff ff       	jmp    801059d5 <alltraps>
...
801062df:	6a 76                	push   $0x76
  jmp alltraps
801062e1:	e9 ef f6 ff ff       	jmp    801059d5 <alltraps>
...
801062e8:	6a 77                	push   $0x77
  jmp alltraps
801062ea:	e9 e6 f6 ff ff       	jmp    801059d5 <alltraps>
...
801062f1:	6a 78                	push   $0x78
  jmp alltraps
801062f3:	e9 dd f6 ff ff       	jmp    801059d5 <alltraps>
...
801062fa:	6a 79                	push   $0x79
  jmp alltraps
801062fc:	e9 d4 f6 ff ff       	jmp    801059d5 <alltraps>
...
80106303:	6a 7a                	push   $0x7a
  jmp alltraps
80106305:	e9 cb f6 ff ff       	jmp    801059d5 <alltraps>
...
8010630c:	6a 7b                	push   $0x7b
  jmp alltraps
8010630e:	e9 c2 f6 ff ff       	jmp    801059d5 <alltraps>
...
80106315:	6a 7c                	push   $0x7c
  jmp alltraps
80106317:	e9 b9 f6 ff ff       	jmp    801059d5 <alltraps>
...
8010631e:	6a 7d                	push   $0x7d
  jmp alltraps
80106320:	e9 b0 f6 ff ff       	jmp    801059d5 <alltraps>
...
80106327:	6a 7e                	push   $0x7e
  jmp alltraps
80106329:	e9 a7 f6 ff ff       	jmp    801059d5 <alltraps>
...
80106330:	6a 7f                	push   $0x7f
  jmp alltraps
80106332:	e9 9e f6 ff ff       	jmp    801059d5 <alltraps>
...
80106339:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010633e:	e9 92 f6 ff ff       	jmp    801059d5 <alltraps>
...
80106345:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010634a:	e9 86 f6 ff ff       	jmp    801059d5 <alltraps>
...
80106351:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106356:	e9 7a f6 ff ff       	jmp    801059d5 <alltraps>
...
8010635d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106362:	e9 6e f6 ff ff       	jmp    801059d5 <alltraps>
...
80106369:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010636e:	e9 62 f6 ff ff       	jmp    801059d5 <alltraps>
...
80106375:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010637a:	e9 56 f6 ff ff       	jmp    801059d5 <alltraps>
...
80106381:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106386:	e9 4a f6 ff ff       	jmp    801059d5 <alltraps>
...
8010638d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106392:	e9 3e f6 ff ff       	jmp    801059d5 <alltraps>
...
80106399:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010639e:	e9 32 f6 ff ff       	jmp    801059d5 <alltraps>
...
801063a5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801063aa:	e9 26 f6 ff ff       	jmp    801059d5 <alltraps>
...
801063b1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801063b6:	e9 1a f6 ff ff       	jmp    801059d5 <alltraps>
...
801063bd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801063c2:	e9 0e f6 ff ff       	jmp    801059d5 <alltraps>
...
801063c9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801063ce:	e9 02 f6 ff ff       	jmp    801059d5 <alltraps>
...
801063d5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801063da:	e9 f6 f5 ff ff       	jmp    801059d5 <alltraps>
...
801063e1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801063e6:	e9 ea f5 ff ff       	jmp    801059d5 <alltraps>
...
801063ed:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801063f2:	e9 de f5 ff ff       	jmp    801059d5 <alltraps>
...
801063f9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801063fe:	e9 d2 f5 ff ff       	jmp    801059d5 <alltraps>
...
80106405:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010640a:	e9 c6 f5 ff ff       	jmp    801059d5 <alltraps>
...
80106411:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106416:	e9 ba f5 ff ff       	jmp    801059d5 <alltraps>
...
8010641d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106422:	e9 ae f5 ff ff       	jmp    801059d5 <alltraps>
...
80106429:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010642e:	e9 a2 f5 ff ff       	jmp    801059d5 <alltraps>
...
80106435:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010643a:	e9 96 f5 ff ff       	jmp    801059d5 <alltraps>
...
80106441:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106446:	e9 8a f5 ff ff       	jmp    801059d5 <alltraps>
...
8010644d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106452:	e9 7e f5 ff ff       	jmp    801059d5 <alltraps>
...
80106459:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010645e:	e9 72 f5 ff ff       	jmp    801059d5 <alltraps>
...
80106465:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010646a:	e9 66 f5 ff ff       	jmp    801059d5 <alltraps>
...
80106471:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106476:	e9 5a f5 ff ff       	jmp    801059d5 <alltraps>
...
8010647d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106482:	e9 4e f5 ff ff       	jmp    801059d5 <alltraps>
...
80106489:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010648e:	e9 42 f5 ff ff       	jmp    801059d5 <alltraps>
...
80106495:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010649a:	e9 36 f5 ff ff       	jmp    801059d5 <alltraps>
...
801064a1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801064a6:	e9 2a f5 ff ff       	jmp    801059d5 <alltraps>
...
801064ad:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801064b2:	e9 1e f5 ff ff       	jmp    801059d5 <alltraps>
...
801064b9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801064be:	e9 12 f5 ff ff       	jmp    801059d5 <alltraps>
...
801064c5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801064ca:	e9 06 f5 ff ff       	jmp    801059d5 <alltraps>
...
801064d1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801064d6:	e9 fa f4 ff ff       	jmp    801059d5 <alltraps>
...
801064dd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801064e2:	e9 ee f4 ff ff       	jmp    801059d5 <alltraps>
...
801064e9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801064ee:	e9 e2 f4 ff ff       	jmp    801059d5 <alltraps>
...
801064f5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801064fa:	e9 d6 f4 ff ff       	jmp    801059d5 <alltraps>
...
80106501:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106506:	e9 ca f4 ff ff       	jmp    801059d5 <alltraps>
...
8010650d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106512:	e9 be f4 ff ff       	jmp    801059d5 <alltraps>
...
80106519:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010651e:	e9 b2 f4 ff ff       	jmp    801059d5 <alltraps>
...
80106525:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010652a:	e9 a6 f4 ff ff       	jmp    801059d5 <alltraps>
...
80106531:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106536:	e9 9a f4 ff ff       	jmp    801059d5 <alltraps>
...
8010653d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106542:	e9 8e f4 ff ff       	jmp    801059d5 <alltraps>
...
80106549:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010654e:	e9 82 f4 ff ff       	jmp    801059d5 <alltraps>
...
80106555:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010655a:	e9 76 f4 ff ff       	jmp    801059d5 <alltraps>
...
80106561:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106566:	e9 6a f4 ff ff       	jmp    801059d5 <alltraps>
...
8010656d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106572:	e9 5e f4 ff ff       	jmp    801059d5 <alltraps>
...
80106579:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010657e:	e9 52 f4 ff ff       	jmp    801059d5 <alltraps>
...
80106585:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010658a:	e9 46 f4 ff ff       	jmp    801059d5 <alltraps>
...
80106591:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106596:	e9 3a f4 ff ff       	jmp    801059d5 <alltraps>
...
8010659d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801065a2:	e9 2e f4 ff ff       	jmp    801059d5 <alltraps>
...
801065a9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801065ae:	e9 22 f4 ff ff       	jmp    801059d5 <alltraps>
...
801065b5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801065ba:	e9 16 f4 ff ff       	jmp    801059d5 <alltraps>
...
801065c1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801065c6:	e9 0a f4 ff ff       	jmp    801059d5 <alltraps>
...
801065cd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801065d2:	e9 fe f3 ff ff       	jmp    801059d5 <alltraps>
...
801065d9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801065de:	e9 f2 f3 ff ff       	jmp    801059d5 <alltraps>
...
801065e5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801065ea:	e9 e6 f3 ff ff       	jmp    801059d5 <alltraps>
...
801065f1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801065f6:	e9 da f3 ff ff       	jmp    801059d5 <alltraps>
...
801065fd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106602:	e9 ce f3 ff ff       	jmp    801059d5 <alltraps>
...
80106609:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010660e:	e9 c2 f3 ff ff       	jmp    801059d5 <alltraps>
...
80106615:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010661a:	e9 b6 f3 ff ff       	jmp    801059d5 <alltraps>
...
80106621:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106626:	e9 aa f3 ff ff       	jmp    801059d5 <alltraps>
...
8010662d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106632:	e9 9e f3 ff ff       	jmp    801059d5 <alltraps>
...
80106639:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010663e:	e9 92 f3 ff ff       	jmp    801059d5 <alltraps>
...
80106645:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010664a:	e9 86 f3 ff ff       	jmp    801059d5 <alltraps>
...
80106651:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106656:	e9 7a f3 ff ff       	jmp    801059d5 <alltraps>
...
8010665d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106662:	e9 6e f3 ff ff       	jmp    801059d5 <alltraps>
...
80106669:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010666e:	e9 62 f3 ff ff       	jmp    801059d5 <alltraps>
...
80106675:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010667a:	e9 56 f3 ff ff       	jmp    801059d5 <alltraps>
...
80106681:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106686:	e9 4a f3 ff ff       	jmp    801059d5 <alltraps>
...
8010668d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106692:	e9 3e f3 ff ff       	jmp    801059d5 <alltraps>
...
80106699:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010669e:	e9 32 f3 ff ff       	jmp    801059d5 <alltraps>
...
801066a5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801066aa:	e9 26 f3 ff ff       	jmp    801059d5 <alltraps>
...
801066b1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801066b6:	e9 1a f3 ff ff       	jmp    801059d5 <alltraps>
...
801066bd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801066c2:	e9 0e f3 ff ff       	jmp    801059d5 <alltraps>
...
801066c9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801066ce:	e9 02 f3 ff ff       	jmp    801059d5 <alltraps>
...
801066d5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801066da:	e9 f6 f2 ff ff       	jmp    801059d5 <alltraps>
...
801066e1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801066e6:	e9 ea f2 ff ff       	jmp    801059d5 <alltraps>
...
801066ed:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801066f2:	e9 de f2 ff ff       	jmp    801059d5 <alltraps>
...
801066f9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801066fe:	e9 d2 f2 ff ff       	jmp    801059d5 <alltraps>
...
80106705:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010670a:	e9 c6 f2 ff ff       	jmp    801059d5 <alltraps>
...
80106711:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106716:	e9 ba f2 ff ff       	jmp    801059d5 <alltraps>
...
8010671d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106722:	e9 ae f2 ff ff       	jmp    801059d5 <alltraps>
...
80106729:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010672e:	e9 a2 f2 ff ff       	jmp    801059d5 <alltraps>
...
80106735:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010673a:	e9 96 f2 ff ff       	jmp    801059d5 <alltraps>
...
80106741:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106746:	e9 8a f2 ff ff       	jmp    801059d5 <alltraps>
...
8010674d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106752:	e9 7e f2 ff ff       	jmp    801059d5 <alltraps>
...
80106759:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010675e:	e9 72 f2 ff ff       	jmp    801059d5 <alltraps>
...
80106765:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010676a:	e9 66 f2 ff ff       	jmp    801059d5 <alltraps>
...
80106771:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106776:	e9 5a f2 ff ff       	jmp    801059d5 <alltraps>
...
8010677d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106782:	e9 4e f2 ff ff       	jmp    801059d5 <alltraps>
...
80106789:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010678e:	e9 42 f2 ff ff       	jmp    801059d5 <alltraps>
...
80106795:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010679a:	e9 36 f2 ff ff       	jmp    801059d5 <alltraps>
...
801067a1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801067a6:	e9 2a f2 ff ff       	jmp    801059d5 <alltraps>
...
801067ad:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801067b2:	e9 1e f2 ff ff       	jmp    801059d5 <alltraps>
...
801067b9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801067be:	e9 12 f2 ff ff       	jmp    801059d5 <alltraps>
...
801067c5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801067ca:	e9 06 f2 ff ff       	jmp    801059d5 <alltraps>
...
801067d1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801067d6:	e9 fa f1 ff ff       	jmp    801059d5 <alltraps>
...
801067dd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801067e2:	e9 ee f1 ff ff       	jmp    801059d5 <alltraps>
...
801067e9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801067ee:	e9 e2 f1 ff ff       	jmp    801059d5 <alltraps>
...
801067f5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801067fa:	e9 d6 f1 ff ff       	jmp    801059d5 <alltraps>
...
80106801:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106806:	e9 ca f1 ff ff       	jmp    801059d5 <alltraps>
...
8010680d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106812:	e9 be f1 ff ff       	jmp    801059d5 <alltraps>
...
80106819:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010681e:	e9 b2 f1 ff ff       	jmp    801059d5 <alltraps>
...
80106825:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010682a:	e9 a6 f1 ff ff       	jmp    801059d5 <alltraps>
...
80106831:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106836:	e9 9a f1 ff ff       	jmp    801059d5 <alltraps>
...
8010683d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106842:	e9 8e f1 ff ff       	jmp    801059d5 <alltraps>
...
80106849:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010684e:	e9 82 f1 ff ff       	jmp    801059d5 <alltraps>
...
80106855:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010685a:	e9 76 f1 ff ff       	jmp    801059d5 <alltraps>
...
80106861:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106866:	e9 6a f1 ff ff       	jmp    801059d5 <alltraps>
...
8010686d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106872:	e9 5e f1 ff ff       	jmp    801059d5 <alltraps>
...
80106879:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010687e:	e9 52 f1 ff ff       	jmp    801059d5 <alltraps>
...
80106885:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010688a:	e9 46 f1 ff ff       	jmp    801059d5 <alltraps>
...
80106891:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106896:	e9 3a f1 ff ff       	jmp    801059d5 <alltraps>
...
8010689d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801068a2:	e9 2e f1 ff ff       	jmp    801059d5 <alltraps>
...
801068a9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801068ae:	e9 22 f1 ff ff       	jmp    801059d5 <alltraps>
...
801068b5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801068ba:	e9 16 f1 ff ff       	jmp    801059d5 <alltraps>
...
801068c1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801068c6:	e9 0a f1 ff ff       	jmp    801059d5 <alltraps>
...
801068cd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801068d2:	e9 fe f0 ff ff       	jmp    801059d5 <alltraps>
...
801068d9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801068de:	e9 f2 f0 ff ff       	jmp    801059d5 <alltraps>
...
801068e5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801068ea:	e9 e6 f0 ff ff       	jmp    801059d5 <alltraps>
...
801068f1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801068f6:	e9 da f0 ff ff       	jmp    801059d5 <alltraps>
...
801068fd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106902:	e9 ce f0 ff ff       	jmp    801059d5 <alltraps>
...
80106909:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010690e:	e9 c2 f0 ff ff       	jmp    801059d5 <alltraps>
...
80106915:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010691a:	e9 b6 f0 ff ff       	jmp    801059d5 <alltraps>
...
80106921:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106926:	e9 aa f0 ff ff       	jmp    801059d5 <alltraps>
...
8010692d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106932:	e9 9e f0 ff ff       	jmp    801059d5 <alltraps>
...
80106a85:	e8 66 dd ff ff       	call   801047f0 <memset>
...
80106acd:	68 4c 7c 10 80       	push   $0x80107c4c
...
80106b70:	a1 e4 46 11 80       	mov    0x801146e4,%eax
...
80106ba4:	0f 84 c2 00 00 00    	je     80106c6c <switchuvm+0xec>
  pushcli();
80106baa:	e8 31 da ff ff       	call   801045e0 <pushcli>
...
80106cbf:	e8 2c db ff ff       	call   801047f0 <memset>
...
80106cf2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cf3:	e9 98 db ff ff       	jmp    80104890 <memmove>
    panic("inituvm: more than a page");
80106cf8:	83 ec 0c             	sub    $0xc,%esp
80106cfb:	68 91 7c 10 80       	push   $0x80107c91
...
80106d60:	68 ab 7c 10 80       	push   $0x80107cab
...
80106de8:	68 4c 7d 10 80       	push   $0x80107d4c
...
80106e4b:	e8 a0 d9 ff ff       	call   801047f0 <memset>
...
80106e89:	68 c9 7c 10 80       	push   $0x80107cc9
...
80106eeb:	68 e1 7c 10 80       	push   $0x80107ce1
...
80106fcc:	68 fd 7c 10 80       	push   $0x80107cfd
...
80107000:	e8 eb d7 ff ff       	call   801047f0 <memset>
...
8010706b:	a3 e4 46 11 80       	mov    %eax,0x801146e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010709c:	68 0e 7d 10 80       	push   $0x80107d0e
...
80107112:	68 18 7d 10 80       	push   $0x80107d18
...
80107170:	e8 1b d7 ff ff       	call   80104890 <memmove>
...
801071e7:	68 32 7d 10 80       	push   $0x80107d32
...
801072a0:	e8 eb d5 ff ff       	call   80104890 <memmove>
    len -= n;
    buf += n;
