...
_proc_dump:     file format elf32-i386
...
main(int argc, char **argv) {
  ...
  1b:	7f 6d                	jg     8a <main+0x8a>
        TESTNUM = atoi(argv[1]);
    if (argc >= 3)
        SIZE = atoi(argv[2]);
    
    printf(1, "Number of processes: %d\nSize of processes: %d int = %d*4 = %d\n", TESTNUM, SIZE, SIZE, SIZE*4);
  1d:	a1 e8 0a 00 00       	mov    0xae8,%eax
  22:	83 ec 08             	sub    $0x8,%esp
  25:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  2c:	52                   	push   %edx
  2d:	50                   	push   %eax
  2e:	50                   	push   %eax
  2f:	ff 35 ec 0a 00 00    	push   0xaec
  35:	68 98 07 00 00       	push   $0x798
  3a:	6a 01                	push   $0x1
  3c:	e8 2f 04 00 00       	call   470 <printf>
    
    for (int i = 0; i < TESTNUM; i++)
  41:	a1 ec 0a 00 00       	mov    0xaec,%eax
  46:	83 c4 20             	add    $0x20,%esp
  49:	85 c0                	test   %eax,%eax
  4b:	7e 1d                	jle    6a <main+0x6a>
  4d:	31 db                	xor    %ebx,%ebx
    {
        rs[i] = fork();
  4f:	e8 b7 02 00 00       	call   30b <fork>
  54:	89 04 9d 00 0b 00 00 	mov    %eax,0xb00(,%ebx,4)
        if (rs[i] == 0)
  5b:	85 c0                	test   %eax,%eax
  5d:	74 15                	je     74 <main+0x74>
    for (int i = 0; i < TESTNUM; i++)
  5f:	83 c3 01             	add    $0x1,%ebx
  62:	39 1d ec 0a 00 00    	cmp    %ebx,0xaec
  68:	7f e5                	jg     4f <main+0x4f>
            }
            while (1) continue;
            exit();
        }
    ...
    proc_dump();
  6a:	e8 44 03 00 00       	call   3b3 <proc_dump>
    exit();
  6f:	e8 9f 02 00 00       	call   313 <exit>
            int* a1 = malloc(SIZE * sizeof(int));
  74:	a1 e8 0a 00 00       	mov    0xae8,%eax
  79:	83 ec 0c             	sub    $0xc,%esp
  7c:	c1 e0 02             	shl    $0x2,%eax
  7f:	50                   	push   %eax
  80:	e8 1b 06 00 00       	call   6a0 <malloc>
            for (int j = 0; j < 1000; j++)
  85:	83 c4 10             	add    $0x10,%esp
            while (1) continue;
  88:	eb fe                	jmp    88 <main+0x88>
        TESTNUM = atoi(argv[1]);
  8a:	83 ec 0c             	sub    $0xc,%esp
  8d:	ff 76 04             	push   0x4(%esi)
  90:	e8 0b 02 00 00       	call   2a0 <atoi>
    if (argc >= 3)
  95:	83 c4 10             	add    $0x10,%esp
        TESTNUM = atoi(argv[1]);
  98:	a3 ec 0a 00 00       	mov    %eax,0xaec
    if (argc >= 3)
  9d:	83 fb 02             	cmp    $0x2,%ebx
  a0:	0f 84 77 ff ff ff    	je     1d <main+0x1d>
        SIZE = atoi(argv[2]);
  a6:	83 ec 0c             	sub    $0xc,%esp
  a9:	ff 76 08             	push   0x8(%esi)
  ac:	e8 ef 01 00 00       	call   2a0 <atoi>
  b1:	83 c4 10             	add    $0x10,%esp
  b4:	a3 e8 0a 00 00       	mov    %eax,0xae8
  b9:	e9 5f ff ff ff       	jmp    1d <main+0x1d>
  be:	66 90                	xchg   %ax,%ax
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba d7 07 00 00       	mov    $0x7d7,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 50 0b 00 00       	mov    0xb50,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 50 0b 00 00    	mov    %edx,0xb50
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 50 0b 00 00    	mov    %edx,0xb50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 50 0b 00 00    	mov    0xb50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 50 0b 00 00    	mov    0xb50,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 50 0b 00 00    	mov    0xb50,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 50 0b 00 00    	mov    %edx,0xb50
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 50 0b 00 00 54 	movl   $0xb54,0xb50
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 54 0b 00 00       	mov    $0xb54,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 54 0b 00 00 54 	movl   $0xb54,0xb54
 776:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 58 0b 00 00 00 	movl   $0x0,0xb58
 782:	00 00 00 
    if(p->s.size >= nunits){
